  ...
  (function(f) {
    ...
    return (function e(t, n, r) {
      ...
      12: [function(_dereq_, module, exports) {
        ...
        "./source-map/source-map-consumer": 19,
        "./source-map/source-map-generator": 20,
        "./source-map/source-node": 21
      }],
      ...
      28: [function(_dereq_, module, exports) {
        ...
        "../visitors": 43,
        "../visitors/type-syntax": 50,
        "./inline-source-map": 26,
        "./jstransform": 27,
        "fs": 2,
        "object-assign": 11
      }],
      ...
      30: [function(_dereq_, module, exports) {
        ...
        function visitArrowFunction(traverse, node, path, state) {
          ...
          var containsBindingSyntax = utils.containsChildMatching(node.body, function(node) {
            return node.type === Syntax.ThisExpression || (node.type === Syntax.Identifier && node.name === "super") || (node.type === Syntax.JSXIdentifier && node.name === 'this');
          });
        ...
        "../src/utils": 29,
        "./es6-destructuring-visitors": 33,
        "./es6-rest-param-visitors": 38,
        "esprima-fb": 10
      }],
      ...
      35: [function(_dereq_, module, exports) {
        ...
        "../src/utils": 29,
        "./es6-object-concise-method-visitors": 36,
        "./es7-spread-property-visitors": 41,
        "esprima-fb": 10
      }],
        ...
        function visitTemplateLiteral(traverse, node, path, state) {
          ...
          for (var ii = 0; ii < templateElements.length; ii++) {
            ...
            if (!templateElement.tail) {
              ...
              if (substitution.type === Syntax.Identifier || substitution.type === Syntax.Literal || substitution.type === Syntax.MemberExpression || substitution.type === Syntax.CallExpression) {
      ...
      41: [function(_dereq_, module, exports) {
        ...
        function visitObjectLiteralSpread(traverse, node, path, state) {
          ...
          var lastWasSpread = renderSpreadProperties(traverse, node.properties, path, state, false);
      ...
      43: [function(_dereq_, module, exports) {
        ...
        var es6ObjectComputedProperty = _dereq_('./es6-object-computed-property-visitors');
        ...
        "./es6-arrow-function-visitors": 30,
        "./es6-call-spread-visitors": 31,
        "./es6-class-visitors": 32,
        "./es6-destructuring-visitors": 33,
        "./es6-for-of-visitors": 34,
        "./es6-object-computed-property-visitors": 35,
        "./es6-object-concise-method-visitors": 36,
        "./es6-object-short-notation-visitors": 37,
        "./es6-rest-param-visitors": 38,
        "./es6-template-visitors": 39,
        "./es7-spread-property-visitors": 41,
        "./es7-trailing-comma-visitors": 42,
        "./react-display-name-visitors": 45,
        "./react-jsx-visitors": 46,
        "./reserved-words-visitors": 48,
        "./trailing-comma-visitors": 49,
        "./undefined-to-void-0-visitors": 51
      }],
      ...
      50: [function(_dereq_, module, exports) {
        ...
        visitImportType.test = function(node, path, state) {
          return node.type === 'ImportDeclaration' && (node.importKind === 'type' || node.importKind === 'typeof');
        };
        function visitExportType(traverse, node, path, state) {
          utils.catchupWhiteOut(node.range[1], state);
        }
        visitExportType.test = function(node, path, state) {
          return node.type === 'ExportDeclaration' && node.declaration.type === 'TypeAlias';
        };
        exports.visitorList = [visitClassProperty, visitDeclare, visitExportType, visitImportType, visitInterfaceDeclaration, visitFunctionParametricAnnotation, visitFunctionReturnAnnotation, visitMethod, visitOptionalFunctionParameterAnnotation, visitTypeAlias, visitTypeCast, visitTypeAnnotatedIdentifier, visitTypeAnnotatedObjectOrArrayPattern];
      }, {
        "../src/utils": 29,
        "esprima-fb": 10
      }],
